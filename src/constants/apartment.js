import {
  ...
  LOCALE_ORDER_STEP_ONE,
  LOCALE_ORDER_STEP_ONE_SIMPLE,
  LOCALE_ORDER_STEP_TWO,
  LOCALE_ORDER_STEP_TWO_SIMPLE,
  LOCALE_ORDER_STEP_THREE,
  LOCALE_ORDER_STEP_THREE_SIMPLE,
  LOCALE_ORDER_STEP_FOUR,
...
export const ORDER_PROCESS = [
  ...
  { url: ORDER_STEP_TWO, title: LOCALE_ORDER_STEP_TWO },
  { url: ORDER_STEP_THREE, title: LOCALE_ORDER_STEP_THREE },
  { url: ORDER_STEP_FOUR, title: LOCALE_ORDER_STEP_FOUR }
]

//  简单流程图
export const ORDER_PROCESS_SIMPLE = [
  { url: ORDER_SIGN, title: LOCALE_ORDER_STEP_ONE_SIMPLE },
  { url: MANAGER_CONFIRM, title: LOCALE_ORDER_STEP_TWO_SIMPLE },
  { url: SIGN_SUCCESS, title: LOCALE_ORDER_STEP_THREE_SIMPLE },
]
