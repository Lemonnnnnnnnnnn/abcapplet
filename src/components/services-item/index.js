    ...
    return (
      <View className='pl-3 pr-2 pb-3 mt-1' style='position:relative ;'>
        <View  className={classNames('apartment')} >
          ...
          {/* 头部 公寓类型以及查看详情 */}
          <View  className='at-row p-2 at-row at-row__justify--between service-head ml-2' >
              <View className='at-row at-row-5 mt-1' style='color:#FFFFFF ;font-size:17px' >{apartment_title}</View>
