  ...
  render() {
    ...
    const bargainLeaderboard = <View className='at-row at-row__align--center at-row__justify--between '>
      <View className='at-row at-row__align--center'>
        {/* 排名 */}
        <Text className='text-secondary text-huge'>{num}.</Text>
        {/* 头像 */}
      ...
      <View className='at-row at-row__align--end at-row__justify--end'>
        <Text className='text-mini text-secondary mb-1 mr-1'>已砍到</Text>
        <Text className='text-huge text-orange'>￥{price}</Text>
      </View>
    </View>
